...
#define vmmio_selected_vq(vdev, vmmio) (vdev)->ops->get_vq((vmmio)->kvm, (vmmio)->dev, (vmmio)->hdr.queue_sel)

static void virtio_mmio_config_in(struct kvm_cpu *vcpu, u64 addr, void *data, u32 len, struct virtio_device *vdev) {
...
static void virtio_mmio_config_out(struct kvm_cpu *vcpu, u64 addr, void *data, u32 len, struct virtio_device *vdev) {
    struct virtio_mmio *vmmio = vdev->virtio;
...
void virtio_mmio_legacy_callback(struct kvm_cpu *vcpu, u64 addr, u8 *data, u32 len, u8 is_write, void *ptr) {
