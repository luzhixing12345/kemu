...
#define AIA_IMSIC_ADDR(__hart) (AIA_IMSIC_BASE + (__hart)*KVM_DEV_RISCV_IMSIC_SIZE)
...
static void aia__generate_fdt_node(void *fdt, struct kvm *kvm) {
    ...
    _FDT(fdt_property(fdt, "interrupts-extended", irq_cells, sizeof(u32) * aia_nr_harts * 2));
