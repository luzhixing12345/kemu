...
extern void (*riscv_irqchip_trigger)(struct kvm *kvm, int irq, int level, bool edge);
...
int riscv__add_irqfd(struct kvm *kvm, unsigned int gsi, int trigger_fd, int resample_fd);
