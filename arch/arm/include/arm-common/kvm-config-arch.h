...
#define OPT_ARCH_RUN(pfx, cfg)                                                                                  \
    pfx,                                                                                                        \
        ARM_OPT_ARCH_RUN(cfg) OPT_STRING(                                                                       \
            '\0', "dump-dtb", &(cfg)->dump_dtb_filename, ".dtb file", "Dump generated .dtb to specified file"), \
        OPT_UINTEGER('\0',                                                                                      \
                     "override-bad-firmware-cntfrq",                                                            \
                     &(cfg)->force_cntfrq,                                                                      \
        ...
        OPT_CALLBACK('\0',                                                                                      \
                     ...
                     irqchip_parser,                                                                            \
                     NULL),                                                                                     \
        OPT_U64('\0', "firmware-address", &(cfg)->fw_addr, "Address where firmware should be loaded"),
